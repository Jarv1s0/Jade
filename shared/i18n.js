    ...
    zh_CN: {
      ...
      popup: {
        ...
        toasts: {
          ...
          bookmarkEditDone: '书签已更新',
          bookmarkEditFailed: '编辑失败：{{reason}}',
          bookmarkMoveDone: '书签已移动',
          bookmarkMoveFailed: '移动失败：{{reason}}'
        },
        move: {
          title: '移动到文件夹',
          folderLabel: '目标文件夹',
          loading: '正在读取文件夹...',
          currentFolder: '{{name}}（当前）',
          noDestination: '没有其他可用的目标文件夹。',
          confirm: '移动'
        },
        edit: {
          titleFolder: '编辑文件夹',
        ...
        tools: {
          ...
          duplicatesWarning: '💡 提示：基于完全相同的 URL 来判断重复。删除后无法在此处恢复，请确认选择无误。',
          ...
          statsUniqueDomains: '唯一域名',
          statsUniqueUrls: '唯一链接',
          statsMaxDepth: '最深层级',
          statsEmptyFolders: '空文件夹',
          statsTopDomains: '域名分布 Top 10',
          statsLinkDistribution: '链接分布',
          statsStructureHealth: '结构健康度',
          statsHttpsLinks: 'HTTPS 链接',
          statsHttpLinks: 'HTTP 链接',
          statsOtherProtocols: '其他协议',
          statsDuplicateLinks: '重复链接',
          statsRootLevelBookmarks: '根目录书签',
          statsUntitledItems: '无标题项',
          statsAvgPerFolder: '平均每文件夹书签',
          statsLargestFolder: '最大文件夹',
          statsNone: '无',
          statsGroups: '{{count}} 组',
          statsItems: '{{count}} 项',
          statsCountWithPercent: '{{count}} 项（{{percent}}%）',
          statsAvgValue: '{{value}} / 文件夹',
          ...
          brokenIdle: '状态：尚未扫描',
          brokenStart: '开始检测',
          brokenWarning: '⚠️ 新策略：优先用 HEAD 探测并分级重试；无法高置信判定的条目会标记为“待复核”。删除前请仔细检查选中的链接。',
          brokenCollecting: '运行中：正在收集所有链接...',
          brokenModuleMissing: '状态：工具模块未加载，无法执行检测',
          brokenModuleMissingResult: '请刷新扩展后重试',
          brokenPermissionRequired: '需要网站访问权限才能检测书签链接。',
          brokenPermissionRequiredResult: '请在权限提示中允许访问网站，然后重试。',
          brokenRetry: '重新检测',
          ...
          emptyFoldersWarning: '💡 提示：扫描并永久清理内部不含有任何书签、也没有有效子文件夹的空壳目录。删除前请仔细检查选中的文件夹。',
          ...
          batchReplaceDesc: '使用正则表达式批量修改书签链接',
          batchReplaceRuleTitle: '查找与替换规则',
          batchReplaceFindPlaceholder: '正则表达式 (例如: old-domain\\.com 或 /old/i)',
          ...
          batchReplaceHint: '请在上方输入正则表达式和替换内容，然后点击"执行预演"',
          batchReplaceWarning: '⚠️ <strong>风险提示：</strong> 正式替换不可撤销，请先执行预演并仔细确认结果。',
          batchReplaceReadyHint: '已输入正则规则，点击"执行预演"查看将要被替换的链接。',
          batchReplaceInvalidRegex: '正则表达式无效：{{reason}}',
    ...
    en: {
      ...
      popup: {
        ...
        toasts: {
          ...
          bookmarkEditDone: 'Bookmark updated',
          bookmarkEditFailed: 'Edit failed: {{reason}}',
          bookmarkMoveDone: 'Bookmark moved',
          bookmarkMoveFailed: 'Move failed: {{reason}}'
        },
        move: {
          ...
          noDestination: 'No other destination folder is available.',
          confirm: 'Move'
        },
        edit: {
        ...
        tools: {
          ...
          duplicatesWarning: '💡 Duplicates are detected by exact URL match. Deleted bookmarks cannot be restored here, so review the selection first.',
          ...
          statsUniqueDomains: 'Unique Domains',
          statsUniqueUrls: 'Unique URLs',
          statsMaxDepth: 'Max Depth',
          statsEmptyFolders: 'Empty Folders',
          statsTopDomains: 'Top 10 Domains',
          statsLinkDistribution: 'Link Distribution',
          statsStructureHealth: 'Structure Health',
          statsHttpsLinks: 'HTTPS Links',
          statsHttpLinks: 'HTTP Links',
          statsOtherProtocols: 'Other Protocols',
          statsDuplicateLinks: 'Duplicate Links',
          statsRootLevelBookmarks: 'Root-Level Bookmarks',
          statsUntitledItems: 'Untitled Items',
          statsAvgPerFolder: 'Avg Bookmarks per Folder',
          statsLargestFolder: 'Largest Folder',
          statsNone: 'None',
          statsGroups: '{{count}} groups',
          statsItems: '{{count}} items',
          statsCountWithPercent: '{{count}} items ({{percent}}%)',
          statsAvgValue: '{{value}} / folder',
          ...
          brokenWarning: '⚠️ Strategy: probe with HEAD first, retry by confidence level, and mark uncertain links for manual review. Review selected links before deletion.',
          ...
          brokenPermissionRequired: 'Website access permission is required to check bookmark links.',
          brokenPermissionRequiredResult: 'Grant website access when prompted, then try again.',
          ...
          emptyFoldersWarning: '💡 Finds and permanently removes folders that contain neither bookmarks nor any valid child folders. Review selected folders before deletion.',
          ...
          batchReplaceFindPlaceholder: 'Regex pattern (for example: old-domain\\.com or /old/i)',
          ...
          batchReplaceHint: 'Enter a regex pattern and replacement text above, then click "Preview Changes".',
          batchReplaceWarning: '⚠️ <strong>Risk:</strong> replacement cannot be undone. Preview the results carefully before applying changes.',
          batchReplaceReadyHint: 'A regex rule is ready. Click "Preview Changes" to inspect replacements.',
          batchReplaceInvalidRegex: 'Invalid regular expression: {{reason}}',
